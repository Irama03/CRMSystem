...
public class Task {
    ...
    public Task(Long id, String name, Flow flow, String description, Date deadline,
                ...
                Worker creator, Worker responsibleWorker, Worker performer, boolean isTemplate) {
        this.id = id;
        this.name = name;
        this.flow = flow;
        ...
        if (performer == null)
            this.performer = responsibleWorker;
        else this.performer = performer;
